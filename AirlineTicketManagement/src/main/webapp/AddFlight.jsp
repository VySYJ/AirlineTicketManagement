<%-- 
    Document   : AddFlight
    Created on : Feb 16, 2023, 9:24:58 AM
    Author     : hp
--%>
    ...
    <div id="wrapper">
        <div class="container">
            <div class="row justify-content-around">
                <p id="message"></p>
                <form action="" class="col-md-6 p-3" method="post" name="form_1" id="my_form">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="date" name="dteG" id="" class="form-control"required>
                     </div>
                     <div class="form-group">
