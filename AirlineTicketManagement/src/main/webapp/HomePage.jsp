    ...
    <body>
        ...
        <div class="Homepage">
            ...
            <div id="cards_landscape_wrap-2">
                <div class="container">
                    <div class="row">
                        <p class="dealhotel"><img class="icon-hot" src="img/icon-hot.png">KHÁCH SẠN</p>
        ...
        <script>
            ...
            var tinhthanhpho = ["Tp Hồ Chí Minh SGN", "Đà Nẵng DAD", "Phú Quốc PQC", "Nha Trang CXR", "Buôn Ma Thuột BMV", "Cà Mau CAH", "Cần Thơ VCA", "Chu Lai VCL", "Côn Đảo VCS", "Đà Lạt DLI", "Điện Biên DIN", "Đồng Hới VDH", "Huế HUI", "Hà Nội HAN", "Hải Phòng HPH", "Pleiku PXU", "Quy Nhơn UIH", "Rạch Giá VKG"];
            autocomplete(document.getElementById("myInput1"), tinhthanhpho);
            autocomplete(document.getElementById("myInput2"), tinhthanhpho);
